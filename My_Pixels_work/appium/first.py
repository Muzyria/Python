...
for h in range(1, 13):
    ...
    time_hours = driver.find_element(By.XPATH, f'//android.widget.RadialTimePickerView.RadialPickerTouchHelper[@content-desc="{h}"]').click()
    # time.sleep(0.1)
...
for m in range(0, 60, 5):
    ...
    time_minuts = driver.find_element(By.XPATH, f'//android.widget.RadialTimePickerView.RadialPickerTouchHelper[@content-desc="{m}"]').click()
    # time.sleep(0.1)
